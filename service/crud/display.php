...
<div class="container w-80">
    <div class="row">
        <ul class="nav nav-underline justify-content-center col-sm-12 col-md-12 col-lg-12" style="font-size: 22px; padding: 10px;">
            <li class="nav-item">
              <a class="nav-link" href="user.php" style="color: white; font-style: italic;">Home</a>
            </li>
            <li class="nav-item">
...
<button type="button" class="btn " data-bs-toggle="modal" data-bs-target="#exampleModal">
  <a class="nav-link" href="user.php" style="color: white; font-style: italic; font-size: 18px;">Contact Us</a>
</button>
...
<!-- <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 card" style="width: 18rem;">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 card" style="width: 18rem;">
          <!-- <img src="https://www.gtopcars.com/wp-content/uploads/2021/12/2023-Bugatti-Chiron-Pur-Sport.jpg" class="card-img-top" alt="..." style="height: 180px;"> -->
          <div class="card-body">
            <h5 class="card-title" style="font-weight: 700;">Do you want sell your vehicle?</h5>
            <p class="card-text" style="font-style: italic;">If you want to sell your vehicle you need to insert a image of the car you want to sell.</p>
            <!-- <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                Buy/Try Vehicle
              </button> -->
